...
export default function Sidebar({ userEmail, pages, selectedPageIndex, setSelectedPageIndex, addNewPage, deletePage }) {
  return (
    <div className="w-1/4 min-w-20 max-w-60 h-screen bg-gray-100 fixed p-2">
      <div className="flex items-center gap-2 p-2">
        <img src="/profile.jpg" alt="Profile" className="w-6 h-6 rounded-md object-cover" />
        <span className="flex-grow text-sm">{userEmail || 'Guest'}의 Notion</span>
      ...
      <div className="flex flex-col p-1">
        <div className="flex items-center gap-2 px-1 py-2 rounded-md hover:bg-gray-200">
          <svg className="w-5 h-5 fill-gray-600" viewBox="0 0 20 20">
      ...
      <div className="text-xs font-bold text-gray-400 p-2 mt-10">Private</div>
      <div className="flex flex-col p-1">
